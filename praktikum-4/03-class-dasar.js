...
// cek saldo
cekSaldo() {
console.log(`Pemilik: ${this.namaPemilik} | Saldo: Rp${this.saldo.toLocaleString()}`);
}
...
// transfer berhasil
BankAccount.transfer(akun1, akun2, 250000);
akun1.cekSaldo();
akun2.cekSaldo();

// transfer gagal
BankAccount.transfer(akun2, akun1, 1000000);